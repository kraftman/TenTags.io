...
$(function(){userID=$("#userID").val();AddTagVoteListener();AddMenuHandler();AddFilterSearch();GetUserSettings();LoadKeybinds();LoadUserFilters();FilterToggle();Recaptcha();AddInfoBar();HookSubClick();$(".post-full-topbar").click(function(a){console.log(a.currentTarget);$(a.currentTarget).parent().find(".linkImg").toggle()});$(".post").hover(function(a){$(a.target).children(".post-full-bottombar").show()});$(".post").focusout(function(a){$(a.target).children(".post-full-bottombar").hide()})});
