...
app:match('api-subscribefilter', '/api/filter/:filterID/sub', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
...
app:match('api-filtersearch', '/api/filter/search/:searchString', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
...
app:match('api-userfilters', '/api/user/filters', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
...
app:match('api-upvotepost', '/api/post/:postID/upvote', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
...
app:match('api-downvotepost', '/api/post/:postID/downvote', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
...
app:match('api-settings', '/api/user/:userID/settings', capture_errors_json({
  on_error = util.HandleJsonError,
    function(request)
...
app:match('api-frontpage', '/api/frontpage', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
...
app:match('api-createfilter', '/api/filters/create', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
...
app:match('api-searchtags', '/api/tags/:searchString', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
...
app:post('api-uploadfile', '/api/i/', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
...
app:post('api-taguser', '/user/tag/:userID', capture_errors_json({
  on_error = util.HandleJsonError,
  function(request)
    if not request.session.userID then
